...
public class ModItems {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, FlybeltMod.MODID);
    ...
    public static final RegistryObject<Item> FLYBELT = ITEMS.register("flybelt",
            () -> new FlybeltItem(ModArmorMaterials.REDSTONE_ALLOY, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
