...
public class ModCreativeModTabs {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS = 
        DeferredRegister.create(Registries.CREATIVE_MODE_TAB, FlybeltMod.MODID);

    public static final RegistryObject<CreativeModeTab> FLYBELT_TAB = CREATIVE_MODE_TABS.register("flybelt",
        () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.REDSTONE_ALLOY_INGOT.get()))
        .title(Component.translatable("creativetab.flybelt_tab"))
        .displayItems((pParameters, pOutput) -> {
            // the order of items here is the order in the tab
            pOutput.accept(ModItems.RAW_REDSTONE_ALLOY.get());
            pOutput.accept(ModItems.REDSTONE_ALLOY_INGOT.get());
